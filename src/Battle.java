public class Battle {
    public void fight(Characteristics hero, Characteristics monster, Realm.FightCallback fightCallback) {
        Runnable runnable = () -> {
            int turn = 1;
    ...
    private Boolean makeHit(Characteristics defender, Characteristics attacker, Realm.FightCallback fightCallback) {
        ...
        if (defenderHealth <= 0 && defender instanceof Hero) {
            System.out.println("Вы повержены...");
            fightCallback.fightLost();
            return true;
        } else if(defenderHealth <= 0) {
            System.out.println(String.format("Вы победили! Вы получаете %d опыта и %d золота", defender.getExperience(), defender.getGold()));
